...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "C:\yolov5\yolov5\data\data_RoadTrash.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / r"C:\yolov5\yolov5\runs\train\exp11\weights\best.pt", help="model path(s)")
