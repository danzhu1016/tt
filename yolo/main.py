...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "YOLOv5 object detection system"))
        self.pushButton_img.setText(_translate("MainWindow", "Download Data"))
        self.pushButton_model.setText(_translate("MainWindow", "Select Model"))
        self.pushButton_detect.setText(_translate("MainWindow", "Target Detection"))
        self.pushButton_camera_detect.setText(_translate("MainWindow", "Camera detection"))
        self.pushButton_showdir.setText(_translate("MainWindow", "Open the output folder"))
...
class DetectionThread(QThread):
    ...
    def run(self):
        detect.run(source=self.file_path, weights=self.model_path[0],   nosave=False)
...
class CameraDetectionThread(QThread):
    ...
    def run(self):
        detect.run(source=0, weights=self.model_path[0], nosave=True, use_camera=True)
